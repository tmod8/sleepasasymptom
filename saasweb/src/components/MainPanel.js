...
const MainPanel = ({navStyle, currentUser}) => (
    <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4 bg-white">
        <div>
            ...
            <Switch>
                <Route path={ROUTES.VIEW_RESEARCHERS} component={ResearchersListContainer} />
                <Route path={ROUTES.CREATE_STUDY} component={CreateStudy} />
                <Route path={ROUTES.VIEW_STUDIES} component={StudiesListContainer} />
                <Route path={ROUTES.PROFILE} component={Profile} />      
                <Route component={StudiesListContainer} />
            </Switch>
        </div>
    </main>
)
